...
/// <summary>
/// Klasa BouncyBullet realizuj¹ca abstrakt pociski odbijaj¹cego siê
/// </summary>
public class BouncyBullet : MonoBehaviour
{
    ...
    /// <summary>
    /// W metodzie Update zapamiêtanie prêdkoœci pocisku w obecnej klatce
    /// </summary>
    private void Update() {
